...
# Move the demo to root folder
  mv out ../../../materio-mui-react-nextjs-admin-template-free-internal/demo-$i
  cd ../../../automation-scripts/react/demo-generation
# Zip and remove demo folder 
  zip -r ../../../materio-mui-react-nextjs-admin-template-free-internal/demo-$i.zip ../../../materio-mui-react-nextjs-admin-template-free-internal/demo-$i
  rm -rf ../../../materio-mui-react-nextjs-admin-template-free-internal/demo-$i
