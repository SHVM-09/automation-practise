...
tsc --project ../../../materio-mui-react-nextjs-admin-template-free-internal/typescript-version/full-version/tsconfig.jsx.json

# Copy package.json, eslintrc, gitignore, prettierrc, Readme, editorconfig files into newly created folder javascript-version
cp ../../../materio-mui-react-nextjs-admin-template-free-internal/typescript-version/full-version/package.json ../../../materio-mui-react-nextjs-admin-template-free-internal/typescript-version/full-version/next.config.js ../../../materio-mui-react-nextjs-admin-template-free-internal/typescript-version/full-version/next-env.d.ts ../../../materio-mui-react-nextjs-admin-template-free-internal/typescript-version/full-version/.gitignore ../../../materio-mui-react-nextjs-admin-template-free-internal/typescript-version/full-version/.prettierrc.js ../../../materio-mui-react-nextjs-admin-template-free-internal/typescript-version/full-version/.editorconfig ../../../materio-mui-react-nextjs-admin-template-free-internal/typescript-version/full-version/.env ../../../materio-mui-react-nextjs-admin-template-free-internal/javascript-version/full-version/

# Copy .vscode & public directories into javascript-version for assets and .vscode configurations
cp -r  ../../../materio-mui-react-nextjs-admin-template-free-internal/typescript-version/full-version/public ../../../materio-mui-react-nextjs-admin-template-free-internal/typescript-version/full-version/styles ../../../materio-mui-react-nextjs-admin-template-free-internal/javascript-version/full-version/
